...
| [Idle-drain observation](https://github.com/1XP-AI/gh-runnerd/blob/6357865735034ff326401c9d535afe5d07ba3433/docs/evidence/g01-idle-drain.md) | Fixture + source at the exact PR #72 head; this file is not on current `origin/main`, and it is not live evidence. | [PR #72 head `6357865735034ff326401c9d535afe5d07ba3433`](https://github.com/1XP-AI/gh-runnerd/commit/6357865735034ff326401c9d535afe5d07ba3433) |
...
The idle-drain link intentionally points at the exact reviewed PR #72 head and
is not copied into this base worktree. Do not turn its offline result into a
live result or claim that PR #72 is mergeable from this packet.
...
| Idle assignment and drain | [idle-drain evidence at PR #72 head](https://github.com/1XP-AI/gh-runnerd/blob/6357865735034ff326401c9d535afe5d07ba3433/docs/evidence/g01-idle-drain.md); [live-canary drain phases](g01-live-canary.md#minimal-execution-phases). | Source + fixture + live gap | Offline hook uses the released listener's `SetMaxRunners(0)` and retains ACK-before-acquisition; client-side request markers do not prove server receipt or an atomic drain. Real old-poll acquisition/idle assignment and busy-safe removal remain unverified. |
